...
class AppColors {
  ...
  static const Color facilityAvailable = Color(0xFF4CAF50);
  static const Color facilityUnavailable = Color(0xFFF44336);
  static const Color facilityMaintenance = Color(0xFFFF9800);
}
